(function () {
  ...
  const articles = {
    ...
    "Current Events": [
      ...
      {
        "title": "Century of Disaster",
        "sub-title": "",
        "author": "Eduardo Galeano",
        "description": [
          "<strong>Stalin</strong>",
        ...
        "imgUrl": `${prefix}galeano-century-of-disaster-main.png`,
        "link": `${prefix}galeano-century-of-disaster.html`,
        "poem": false,
        "mainImg": false,
      },
    ],
    "Memoir": [
      {
        ...
        "imgUrl": `${prefix}exiles-end-9-main.png`,
        "link": `${prefix}exiles-end-9.html`,
        "poem": false,
        "mainImg": false,
      },
    ],
    ...
    "Theater": [
      {
        "title": "HeyZeus - A Modern Mystery Drama",
        "sub-title": "",
        "author": "Frank Thomas Smith",
        "description": [
          "A meeting of True Advertising chaired by the Chairman of the Board: C.B., with several employees: THOMAS, MARGO and JOHN.",
        ...
        "imgUrl": `${prefix}heyzeus-act-2-scene-2-main.png`,
        "link": `${prefix}heyzeus-act-2-scene-2.html`,
        "poem": false,
        "mainImg": false,
      },
    ],
    "Christian Hermeticism": [
      {
        "title": "Meditation on the Seventh Major Arcanum of the Tarot",
        "sub-title": "",
        "author": "",
        "description": [
          "Then the devil left him, and behold, Angels came and ministered to him.",
          "When the unclean spirit has gone out of man, he passes through waterless places seeking rest; and finding none he says: I will return to my house from whence I came. And when he comes he finds it swept and put in order. Then he goes and brings seven other spirits more evil than himself, and they enter and dwell there; and the last state of that man becomes worse than the first.",
          "I have come in my Father’s name, and you do not receive me; if another comes in his own name, him you will receive.",
          "(Matthew iv, 11)",
        ],
        "imgUrl": `${prefix}meditations-tarot-letter-7-main.png`,
        "link": `${prefix}meditations-tarot-letter-7.html`,
        "poem": false,
        "mainImg": false,
      },
      {
        "title": "Meditations on the Eighth Major Arcanum of the Tarot",
        "sub-title": "",
        "author": "",
        "description": [
          "The Son and the Spirit—this is all that is granted to us. With respect to absolute unity or the Father, no one has been able to see him nor will see him in this world, if this is not within the octenary—which is, in fact, the only way whereby one could attain to him.",
        ...
        "imgUrl": `${prefix}meditations-tarot-letter-8-main.png`,
        "link": `${prefix}meditations-tarot-letter-8.html`,
        "poem": false,
        "mainImg": false,
      },
    ],
    "Anthroposophy": [
      {
        "title": "Reorganizing the Civilized World - Volume One",
        "sub-title": "",
        "author": "Rudolf Steiner",
        "description": [
          "Stuttgart, April 22, 1919",
          "In accordance with the program of tonight’s meeting, it will be my task this evening to speak about the Appeal “To the German People and the Civilized World\", which you have in your hands. You will allow me to speak more aphoristically today when speaking to a meeting of people who are essentially familiar with the appeal. Next Monday I will speak more directly about the social views on which the appeal and my book on the social question, which will be published in a few days’ time, are based.",
        ...
        "imgUrl": `${prefix}reorganizing-civilized-world-1-main.png`,
        "link": `${prefix}reorganizing-civilized-world-1.html`,
        "poem": false,
        "mainImg": false,
      },
    ],
    "Fiction": [
      {
        ...
        "imgUrl": `${prefix}rinser-miryam-4-main.jpg`,
        "link": `${prefix}rinser-miryam-4.html`,
        "poem": false,
        "mainImg": false,
      },
    ],
    "Spiritual Science": [
      ...
      },
      {
        ...
        "imgUrl": `${prefix}the-meaning-of-life-main.jpeg`,
        "link": `${prefix}the-meaning-of-life.html`,
        "poem": false,
        "mainImg": false,
      },
    ],
