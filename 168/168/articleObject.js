...
export const articles = {
  ...
  "Mistery Drama": [
    {
      ...
      "description": [
        "<em>Setting:</em> FIRST MAN enters, passes in front of THOMAS.",
        "THOMAS:",
        "Excuse me. Did you see a black man wearing jeans and a blue t-shirt here in the park?",
        "FIRST MAN:",
        "[<em>Stops, peers closely at THOMAS</em>] No, and I hope to God I don’t. [<em>Exit</em>]",
        "THOMAS:",
        "[<em>To the audience</em>] See what I mean? The inhabitants of Brooklyn are seldom ambiguous.",
        "[<em>ICE AGENT enters</em>]"
      ],
      "imgUrl": `${prefix}heyzeus-act-3-scene-1-main.png`,
      "link": `${prefix}heyzeus-act-3-scene-1.html`,
      "poem": false,
      "mainImg": false,
    },
    {
      "title": "HeyZeus - a Modern Mistery Drama - Act 3",
      "sub-title": "Scene 2 - A Special Love",
      "author": "Frank Thomas Smith",
      "description": [
        "THOMAS: [<em>To the audience</em>] That’s it. Do you see the problem? I can’t expect even you, whose humble patience is prayed, to suspend disbelief – no, not even you can I expect to believe my story. You heard Bishop Casey: it’s not convincing. What would I think if someone told me what I’ve told you? I’d be skeptical. I might even laugh. There are no witnesses. A kingdom for a witness. The disbelief of others has planted the seeds of doubt in my own mind – very fertile soil. I suppose that man is born to doubt. Without doubt, after all, there’d be no belief. Doubt and faith belong together like a couple in love, or a pair of ducks in the lake. If only it were otherwise.",
        "I come here every once in a while in the hope that he’ll appear again – but he hasn’t, yet. And the world seems more screwed up than ever. I came today because, well, I guess it was a dream. In it I received a message from a pigeon that I should go to the park, so I did. [<em>Sits on bench</em>.] You know that actually there was a witness, sort of: Magdalena. Wasn’t she great? Although she didn’t witness the walking on the lake part. But you know, in the meanwhile I’ve been studying something called Anthroposophy, which is a teaching by an Austrian guy named Rudolf Steiner. Problem is he died a hundred years ago, so all there is are books he wrote and the many lectures he gave. He was an initiate, a “Christian Rosicrucian” one. No time to go into what that means now. I’m not sure I know myself anyway. He claimed that the Christ Jesus only came once...physically that is. That the second coming means something else than physical. It means He may come to anyone or everyone, individually, spiritually. Everyone who wants him, that is, I guess.",
        "So where does that leave HeyZeus? Aye, there’s the rub. Was he or wasn’t he the One? We’ll probably never know, because he’s dead. After he was shot dead by that cop, they said he was an illegal immigrant terrorist and scraped him off the ground and dumped him somewhere."
      ],
      "imgUrl": `${prefix}heyzeus-act-2-scene-3-main.png`,
      "link": `${prefix}heyzeus-act-2-scene-3.html`,
      "poem": false,
      "mainImg": false,
    },
  ],
  "From the Archive": [
    {
      ...
      "imgUrl": "https://southerncrossreview.org/147/kutschmann.jpg",
      "link": "https://southerncrossreview.org/147/hunt-a-nazi.html",
      "poem": false,
      "mainImg": false,
    },
    {
    ...
    },
    {
      ...
      "description": [
        ...
        "<span style=\"font-style:italic\">Frank Thomas Smith</span>",
        "The Lord, the Heavenly Hosts, later Mephistopheles.<br/> The Archangels step forward.",
        "<span style=\"font-weight:bold\">RAPHAEL</span>",
        "The sun resounds as once of old<br/>In loving spheres of motley song,<br/>Predestined is its journey bold,<br/>Ripening as it flows along.<br/>Its sight the angels new strength gives,<br/>Though none can fathom how it's done;<br/>The inconceivable still lives<br/>In glory as when the days were one."
      ],
      "imgUrl": "https://southerncrossreview.org/129/faust-mephisto.jpg",
      "link": "https://southerncrossreview.org/129/faust-fts-trans.html",
      "poem": false,
      "mainImg": false,
    },
  ],
  "Fiction": [
    ...
    },
    {
      ...
      "imgUrl": `${prefix}fts-jr-baseball-murders-main.png`,
      "link": `${prefix}fts-jr-baseball-murders.html`,
      "poem": false,
      "mainImg": false,
    },
  ],
  ...
  "Memoir": [
    {
      ...
      "description": [
        ...
        "The most practical option would have been for me to go alone to find somewhere to live, but I didn't want to leave them alone in a place where the police were literally afraid to leave their comisarias. So, we all left together in a long flight. It was much longer than expected because Montevideo, the first stop, was fogged in. We circled around a while and finally returned to Buenos Aires. When the crew received word that Montevideo was open for landing, we took off again. It was like a sign that I wasn't finished with Argentina and that I would be returning.",
      ],
      "imgUrl": `${prefix}exiles-end-11-main.png`,
      "link": `${prefix}exiles-end-11.html`,
      "poem": false,
      "mainImg": false,
    },
  ],
  "Anthroposophy": [
    {
      "title": "Manifestations of Karma",
      "sub-title": "",
      "author": "Rudolf Steiner",
      "description": [
        "17 May 1910, Hamburg",
        "Before we come to the question of human karma, a number of preliminary considerations are necessary. Yesterday we gave a kind of description of the conception of karma, and today we shall have to say something about karma and the animal kingdom.",
      ...
      "imgUrl": `${prefix}steiner-karma-2-main.png`,
      "link": `${prefix}steiner-karma-2.html`,
      "poem": false,
      "mainImg": false,
    },
  ],
  "Current Events": [
    ...
    },
    {
      ...
      "imgUrl": `${prefix}feffer-robocop-main.png`,
      "link": `${prefix}feffer-robocop.html`,
      "poem": false,
      "mainImg": false,
    },
    {
