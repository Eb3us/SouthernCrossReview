...
export const articles = {
  ...
  "Current Events": [
    {
      "title": "Capitulation at Columbia",
      "sub-title": "",
      ...
      "imgUrl": `${prefix}benedict-columbia-main.png`,
      "link": `${prefix}benedict-columbia.html`,
      "poem": false,
      "mainImg": false,
    },
    {
      "title": "Is Trump the New Nero?",
      "sub-title": "",
      ...
      "imgUrl": `${prefix}theoharis-trump-nero-main.png`,
      "link": `${prefix}theoharis-trump-nero.html`,
      "poem": false,
      "mainImg": false,
    },
  ],
  ...
  "Spiritual Science": [
    {
      ...
      "imgUrl": `${prefix}borges-buddhism-main.jpg`,
  ...
  "Fiction": [
    {
      ...
      "imgUrl": `${prefix}borges-abramowicz-main.jpg`,
      "link": `${prefix}borges-abramowicz.html`,
      "poem": false,
      "mainImg": false,
    },
    {
      ...
      "author": "Frank Thomas Smith",
      "description": [
        "It was a long time ago, but I think it's time to tell it before there's no one left to tell it.",
      ...
      "imgUrl": `${prefix}j-r-baseball-murders-1-main.webp`,
      "link": `${prefix}j-r-baseball-murders-1.html`,
      "poem": false,
      "mainImg": false,
    },
    {
      ...
      "imgUrl": `${prefix}pope-and-i-main.jpg`,
      "link": `${prefix}pope-and-i.html`,
      "poem": false,
      "mainImg": false,
    },
  ],
  "Christian Hermeticism": [
    {
      "title": "Meditation on the Ninth Major Arcanum of the Tarot",
      "sub-title": "",
      "author": "Anonymous",
      "description": [
        "Isis: “Give heed, my son Horus; for you shall hear the secret doctrine, of which our forefather Kamephis was the first teacher.",
        "It so befell that Hermes heard this teaching from Kamephis, the eldest of all our race;",
        "I heard it from Hermes,",
        "the writer of the records,",
      ],
      "imgUrl": `${prefix}meditations-tarot-letter-9-main.png`,
      "link": `${prefix}meditations-tarot-letter-9.html`,
      "poem": false,
      "mainImg": false,
    },
    {
      "title": "Meditation on the Tenth Major Arcanum of the Tarot",
      "sub-title": "",
      "author": "",
      "description": [
        ...
        "Qui propter nos homines et propter nostram salutem descendit de coelis. Et incarnatus est de Spiritu Sancto ex Maria Virgine, et homo factus est…et ascendit in coelum, sedet ad dexteram Patris.",
      ],
      "imgUrl": `${prefix}meditations-tarot-10-main.png`,
      "link": `${prefix}meditations-tarot-10.html`,
      "poem": false,
      "mainImg": false,
    },
  ],
