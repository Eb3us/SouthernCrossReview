...
export const articles = {
  ...
  "True Tales": [
    {
      ...
      "imgUrl": `${prefix}girl-in-window.jpg`,
  ...
  "Current Events": [
    ...
    {
      "title": "When Israeli Warplanes Rain Death on Gaza, the Copilot is Uncle Sam",
  ...
  "Poetry": [
    {
      ...
      "description":[
        "My country, ’tis of thee,<br/>Sweet land of liberty,<br/>Would I could sing;<br/>Its land of Pilgrim’s pride<br/>Also where lynched men died<br/>With such upon her tide,<br/>Freedom can’t reign.",
      ],
