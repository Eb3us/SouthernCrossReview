...
export const articles = {
  "Mystery Drama": [
    {
      ...
      "description": [
        "<h2>HeyZeus</h2>", 
        "<h2 style=\"font-size: 1.4em\">A Modern Mystery Drama</h2>",
        "<h2 style=\"font-size: 1.3em \">&nbsp;&nbsp;by Frank Thomas Smith</h2>",
        "Setting: Park bench left of center.",
        "At Rise: Spring, the stage is in darkness when the introductory music begins. A spot shines on THOMAS, standing downstage a few paces right of center. As he speaks, the light gradually expands to reveal the park bench.",
        "<a href=\"/163/heyzeus-1.html\" ><h2 style=\"font-size: 1.2em;\">Continue HeyZeus</h2></a>",
      ],
      "imgUrl": `${prefix}heyzeus-1-main.png`,
      "link": `${prefix}heyzeus-1.html`,
      "poem": false,
      "mainImg": true,
    },
  ],
  ...
  "Children's Corner": [
    {
      ...
      "sub-title": "Chapters 21 and 22",
      "author": "Frank Thomas Smith",
      "description": [
        "They headed straight for the palace and reached its outskirts after dark on the third day. As they got closer Alaram's mood changed. When Sergio asked him why he suddenly seemed so preoccupied, he said that the animals were trying to warn him that something was wrong.",
        "\"I don't know what,\" he explained. \"The animals can't really speak, but they can express things like...\"",
        "\"Like what?\" Mireya asked when he hesitated.",
        "\"Like danger.\"",
        "\"Danger?\" Sergio repeated. He stopped walking forward and the others stopped with him. \"We better be careful. Alaram, let's go on ahead to scout and leave the others here until we find out what the danger may be.\"",
        "\"What about me?\" Divino asked.",
        "\"Come along. You can be our messenger,\" Sergio said.",
        "\"I will go too,\" Alto said.",
        "\"No, Alto,\" Alaram told him, \"you will be in charge here.\"",
      ],
      "imgUrl": `${prefix}magic-mound-cover.png`,
      "link": `${prefix}magic-mound-21-22.html`,
      "poem": false,
      "mainImg": false,
    },
  ],
  "Anthroposophy": [
    {
      ...
      "sub-title": "a continuation",
      "author": "Frank Thomas Smith",
      "description": [
        "In The Artificial Anthroposophical Society I describe the current situation of the problematic General Anthropsophical Society, without recommending a possible solution. Why not? Because I knew of none. Now, however, after some further study, certain concepts which I would like to share with you have fallen into my lap, so to speak.",
        "In February 1935 Ita Wegman wrote to Maria Röschl:",
        "“All the old forms, also the very last one for Anthroposophy (the Christmas Meeting Society 1923) have been basically broken, and it seems to me now that one should no longer seek a form for the life of Anthroposophy, but that every individual is the form with whom Anthroposophy wants unite. Where this is the case, others will find it and join to become members of the true spiritual association. The Anthroposophical Society is no longer necessary because Anthroposophy is already on the earth. It depends now on the individuals and they must together form a higher association, by means of their own development, that has its roots in the spiritual world…”",
        "In March 1935 she wrote in a letter to Herbert Hahn:",
        "“With the Christmas Meeting Dr. Steiner anticipated an organization that was not possible to implement because the old forces did not yet permit it … Perhaps a future form can be possible once some people free themselves from the Society.”"
      ],
      "imgUrl": `${prefix}ita-wegman-main.png`,
      "link": `${prefix}ita-wegman.html`,
      "poem": false,
      "mainImg": false,
    },
    {
      "title": "Rudolf Steiner",
      "sub-title": "A Biographical Sketch",
      "author": "Alfred Heidenreich",
      "description": [
        ...
        "In later life, particularly in his lectures on education, Steiner frequently made the point that the most prodigious feat any man achieves at any time is accomplished by him in the first two or three years of his life, when he lifts his body into the upright position and learns to move it in perfect balance through space, when he forms a vital part of his organism into an instrument of speech and when he begins to handle and indeed to fashion his brain as a vehicle for thought. In other words, when the child asserts his human qualities which set him dramatically apart from the animals.",
      ],
      "imgUrl": `${prefix}rs-heidenreich-main.png`,
      "link": `${prefix}rs-heidenreich.html`,
      "poem": false,
      "mainImg": false,
    },
    {
      ...
      "description": [
        "<span style='font-weight: bold;'>12 February 1906, Cologne GA 97</span>",
      ...
      "imgUrl": `${prefix}steiner-christian-mystery-main.png`,
      "link": `${prefix}steiner-christian-mystery.html`,
      "poem": false,
      "mainImg": false,
    },
    {
      ...
      "imgUrl": `${prefix}steiner-christian-mystery-main.png`,
      "link": `${prefix}steiner-christian-mystery-2.html`,
      "poem": false,
      "mainImg": false,
    },
    {
    ...
    },
    {
      ...
      "author": "Rudolf Steiner",
      "description": [
        "Our considerations will begin with the so-called Pentecost event. For this event presents itself to clairvoyance as a kind of awakening which the personalities on a certain day, Pentecost, experienced: the personalities normally called the apostles or disciples of the Christ Jesus. It is not easy to evoke an exact perception of all those extraordinary events, and we will have to recall – from the depths of our souls, so to speak – much of what we have already gained from our anthroposophical considerations if we want to combine exact perceptions with all which our lecture cycle has to say about this subject.",
        "The apostles felt like awakened individuals who had lived for a long time in an unusual state of consciousness. It was really like a kind of awakening from a deep sleep, from a strange, dream-filled sleep, in which one carries out the everyday tasks of life as reasonable people do, so that others do not notice that one is in a different state of consciousness. Then came the moment when it seemed to the apostles that they had lived through a long time as in a dream from which they awoke with the Pentecost event. And they experienced this awakening in an extraordinary way: they really felt as though something we can only call the substance of all-encompassing love had descended on them from out of the universe. The apostles felt impregnated by all-encompassing love and awakened from the described dream-like state. As though they had been awakened by all that the source of the power of love pervades and warms the universe, as though this source of the power of love had penetrated the soul of each one of them.",
      ],
      "imgUrl": `${prefix}fifth-gospel-2-main.png`,
      "link": `${prefix}fifth-gospel-2.html`,
      "poem": false,
      "mainImg": false,
    },
  ],
  "Current Events": [
    {
      "title": "Trump Faces Palestine",
      "sub-title": "The Colonial View of the World Never Dies",
      ...
      "imgUrl": `${prefix}chomsky-palestine-main.png`,
      "link": `${prefix}chomsky-palestine.html`,
      "poem": false,
      "mainImg": false,
    },
    {
      "title": "The Jewish State of Israel and Me",
      "sub-title": "Why I changed my mind",
      "author": "Frank Thomas Smith",
      "description": [
      ...
      "imgUrl": `${prefix}israel-and-me-main.png`,
      "link": `${prefix}israel-and-me.html`,
      "poem": false,
      "mainImg": false,
    },
    {
      "title": "An All-American Nightmare",
      "sub-title": "How to Build a Deportation Machine in the Age of Trump",
      ...
      "imgUrl": `${prefix}all-american-nightmare-main.jpg`,
      "link": `${prefix}all-american-nightmare.html`,
      "poem": false,
      "mainImg": false,
    },
    {
      "title": "Courage Is Contagious",
      "sub-title": "Moving from Fear to Action in a Disturbing World",
      ...
      "imgUrl": `${prefix}berrigan-courage-main.jpg`,
      "link": `${prefix}berrigan-courage.html`,
      "poem": false,
      "mainImg": false,
    },
  ],
  "Social Science": [
    {
      ...
      "link": `${prefix}favela-children-17.html`,
      "poem": false,
      "mainImg": false,
    },
  ],
