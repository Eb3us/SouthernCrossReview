...
import { mainPage, menuBar, prefix, issueNumber } from "./variables.js";
...
export function createNavMenu(navMenuElement) {
  ...
  function createOldIssuesLink() {
    ...
    a.style.textDecoration = "none";
    p.className = "nav-menu-links";
    a.innerText = "Old Issues";
    p.dataset.title = "old-issues-nav";
    p.appendChild(a);
    div.appendChild(p);
    navMenuElement.appendChild(div);
  }
  function createReincarnationLink() {
    const div = document.createElement("div");
    const p = document.createElement("p");
    const a = document.createElement("a");
    ...
    a.style.textDecoration = "none";
    p.className = "nav-menu-links";
    a.innerText = "Reincarnation Blues";
    p.dataset.title = "reincarnation-nav";
    p.appendChild(a);
    div.appendChild(p);
    navMenuElement.appendChild(div);
  }
